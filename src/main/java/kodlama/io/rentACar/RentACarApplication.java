...
@RestControllerAdvice //bütün controller exceptionHandler kontrolünde 
public class RentACarApplication {
	...
	@ExceptionHandler
	@ResponseStatus(code=HttpStatus.BAD_REQUEST) //eğer bu hata yakalnırsa hata statusunu bad request döndür.
	//BusinessException alırsa çalışır.
